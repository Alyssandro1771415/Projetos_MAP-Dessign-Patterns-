...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("\nVerificando se a lista normal contém a string \"Elemento 3\": " + (normalList.contains("Elemento 1") ? "Contém" : "Não contém"));
    
        // Usando MapToListAdapter
        ...
        System.out.println("\nVerificando se o map adaptado para lista contém a string \"Elemento 3\": " + (mapToListAdapter.contains("Elemento 1") ? "Contém" : "Não contém"));

        System.out.println("---------------------------------------------------------------------------------------------------------");
        // Usando um Map normal
